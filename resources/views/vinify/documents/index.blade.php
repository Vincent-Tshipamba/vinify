<x-app-layout>
    <div class="card p-10 shadow-lg rounded-lg dark:bg-neutral-800">
        <div class="card-body">
            <div class="table-responsive">
                <table border="1" id="documents-table" class="table table-striped dark:text-gray-50 dark:bg-neutral-900 table-bordered rounded-md shadow-lg p-6">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($documents as $key => $document)
                            <tr class="hover:bg-neutral-800 hover:cursor-pointer hover:scale-100 transition-all duration-300 ease-in-out border-b" onclick=" window.location.href='{{ route('documents.show', $document->id) }}'">
                                <td class="">{{ $key + 1 }}</td>
                                <td class=""
                                ...
                                <td class="">{{ substr($document->file_url, 0, 50) }}{{ strlen($document->file_url) > 50 ? '...' : '' }}</td>
                                <td class="">{{ $document->created_at }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <script>
        if (document.getElementById("documents-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const dataTable = new simpleDatatables.DataTable("#documents-table", {
                searchable: true,
                sortable: true,
