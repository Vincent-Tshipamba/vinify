        ...
        <ul class="flex items-center space-x-5 text-sm font-medium">
          ...
          <li>
            <a href="{{route('ai-detection')}}"
               class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Analyse</a>
          </li>
          <li>
            <a href="#"
               class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Services</a>
          </li>
          <li>
            <a href="#"
