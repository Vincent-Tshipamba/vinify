    ...
    <div class="flex items-center space-x-6">
        ...
        <nav class="bg-white/10 dark:bg-neutral-800/50 backdrop-blur-md rounded-full px-6 py-2 shadow-inner">
            <ul class="flex items-center space-x-5 text-sm font-medium">
                <li>
                    <a href="{{ route('dashboard') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Dashboard</a>
                </li>
                <li>
                    <a href="{{ route('ai-detection') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Scanner</a>
                </li>
                <li>
                    <a href="{{ route('analyses.index') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Analyses</a>
                </li>
                <li>
                    <a href="{{ route('documents.index') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Documents</a>
                </li>
                <li>
                    <a href="{{ route('contact') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-yellow-500 transition-colors">Contact</a>
                </li>
            </ul>
        </nav>
